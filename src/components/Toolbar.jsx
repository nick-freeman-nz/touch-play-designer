import { MoveIcon, RouteIcon, PlayIcon, StopIcon, UndoIcon, MirrorIcon, TrashIcon, ResetIcon, DownloadIcon } from './Icons';
      ...
      <div className="flex items-center gap-1.5">
        ...
        {selectedId && selectedId !== 'ball' && (
          <button
            ...
            disabled={isAnimating}
          >
            <XIcon style={{ width: 10, height: 10 }} /> Remove
          </button>
        )}
      </div>
